...
const removeNodeButton = document.querySelector("#remove-button");
const incrementButton = document.getElementById("increment-button");
const mergeButton = document.getElementById("merge-button");
const nodesContainer = document.getElementById("nodes-container");
const nodeRemoveSelection = document.getElementById("remove-node");
const nodeIncrementSelection = document.getElementById("increment-node");
const nodeMergeFromSelection = document.getElementById("merge-from");
const nodeMergeToSelection = document.getElementById("merge-to");
